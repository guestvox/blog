...
class Portada_ThemeCSS
{
	...
	function __construct()
	{
		...
		(
			'100'				=>	array(__('100','portada')),
			'200'				=>	array(__('200','portada')),
			'300'				=>	array(__('300','portada')),
			'400'				=>	array(__('400','portada')),
			'500'				=>	array(__('500','portada')),
			'600'				=>	array(__('600','portada')),
			'700'				=>	array(__('700','portada')),
			'800'				=>	array(__('800','portada')),
			'900'				=>	array(__('900','portada')),	
			'bold'				=>	array(__('bold','portada')),
			'bolder'			=>	array(__('bolder','portada')),
			'inherit'			=>	array(__('inherit','portada')),
			'lighter'			=>	array(__('lighter','portada')),
			'normal'			=>	array(__('normal','portada'))
		);

		$this->fontStyle=array
		(
			'inherit'			=>	array(__('inherit','portada')),
			'italic'			=>	array(__('italic','portada')),
			'normal'			=>	array(__('normal','portada')),
			'oblique'			=>	array(__('oblique','portada'))
		);	
	}
	...
	function create($option,$echo=false)
	{
		...
		Portada_ThemeHelper::removeUIndex($option,array('media',array()),array('selector',array()),'property','portada');
			...
			switch($name)
			{
				...
				case 'font-family':
					...
					foreach((array)$value as $family)
					{
						...
						{
							Portada_ThemeHelper::removeUIndex($data,$name);
