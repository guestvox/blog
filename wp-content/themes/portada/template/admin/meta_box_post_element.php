			...
			<ul class="to-form-field-list">
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_category_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_category_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_category_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_category_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_title_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_title_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_title_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_title_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_author_name_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_author_name_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_author_name_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_author_name_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_date_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_date_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_date_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_date_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_divider_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_divider_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_divider_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_divider_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_image_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_image_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_image_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_image_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_excerpt_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_excerpt_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_excerpt_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_excerpt_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>				
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_content_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_content_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_content_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_content_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>		
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_read_more_button_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_read_more_button_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_read_more_button_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_read_more_button_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_summary_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_summary_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_summary_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_summary_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_tag_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_tag_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_tag_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_tag_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_comment_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_comment_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_comment_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_comment_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_share_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_share_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_share_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_share_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_like_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_like_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_like_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_like_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_author_info_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_author_info_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_author_info_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_author_info_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>				
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_navigation_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_navigation_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_navigation_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_navigation_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
				<li>
					...
					<div class="to-radio-button">
						...
						<input type="radio" name="<?php Portada_ThemeHelper::getFormName('post_related_post_visible'); ?>" id="<?php Portada_ThemeHelper::getFormName('post_related_post_visible_2'); ?>" value="-1" <?php Portada_ThemeHelper::checkedIf($this->data['option']['post_related_post_visible'],-1); ?>/>
						<label for="<?php Portada_ThemeHelper::getFormName('post_related_post_visible_2'); ?>"><?php esc_html_e('Use global settings','portada'); ?></label>
					</div>
				</li>	
			</ul>
		</div>