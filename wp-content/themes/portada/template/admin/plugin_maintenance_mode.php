...
?>
			...
			<li>
				<h5><?php esc_html_e('Disable maintenance mode for IP addreses','portada'); ?></h5>
				<span class="to-legend"><?php esc_html_e('Allow to visit page (in normal mode) visitors from selected (seperated by line break) IP addresses:','portada'); ?></span>
				<div>
