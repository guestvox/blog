...
<?php
		...
		if(Portada_ThemeOption::getGlobalOption($portadaParentPost->post,'footer_instagram_enable')==1)
		{
			...
			echo $Instagram->getLatestUserFeed(Portada_ThemeOption::getOption('footer_instagram_user_id'),Portada_ThemeOption::getOption('footer_instagram_access_token'),Portada_ThemeOption::getOption('footer_instagram_feed_count'));
		}
